...
var UserPagePage = /** @class */ (function () {
    function UserPagePage(router, db, fireauth, toastController) {
        this.router = router;
        this.db = db;
        ...
        this.items$ = this.size$.switchMap(function (size) {
            return db.list('/User', function (ref) {
    ...
    UserPagePage.ctorParameters = function () { return [
...
//# sourceMappingURL=public-user-page-user-page-module-es5.js.map