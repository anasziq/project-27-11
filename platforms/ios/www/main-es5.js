...
var map = {
	...
	"./public/user-page/user-page.module": [
...
var routes = [
    ...
    { path: 'user-page', loadChildren: './public/user-page/user-page.module#UserPagePageModule' }
];
...
var AuthenticationService = /** @class */ (function () {
    function AuthenticationService(storag, plt) {
        var _this = this;
        this.storag = storag;
        this.plt = plt;
    ...
    AuthenticationService.prototype.login = function () {
        var _this = this;
        return this.storag.set(token_key, 'what1234').then(function (res) {
            _this.authenticationState.next(true);
        });
    };
    AuthenticationService.prototype.logout = function () {
        var _this = this;
        return this.storag.remove(token_key).then(function (res) {
    ...
    AuthenticationService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_storage__WEBPACK_IMPORTED_MODULE_3__["Storage"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["Platform"]])
...
module.exports = __webpack_require__(/*! C:\Users\anas ziq\Desktop\TeamWork-master\src\main.ts */"./src/main.ts");
